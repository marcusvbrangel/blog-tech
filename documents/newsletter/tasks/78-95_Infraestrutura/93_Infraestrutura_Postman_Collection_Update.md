# 93_Infraestrutura_Postman_Collection_Update.md

## 📋 Contexto da Tarefa
- **User Story:** Infraestrutura
- **Número da Tarefa:** 93/95
- **Complexidade:** Baixa
- **Estimativa:** 2 horas
- **Dependências:** Tarefa 92
- **Sprint:** Sprint 3

## 🎯 Objetivo
Atualizar Postman collection com todos os endpoints newsletter.
...
Atualizar Postman collection com todos os endpoints newsletter. - Implementar seguindo best practices de infraestrutura e DevOps.
