# 81_Infraestrutura_Criar_Seed_Data_Testes.md

## 📋 Contexto da Tarefa
- **User Story:** Infraestrutura
- **Número da Tarefa:** 81/95
- **Complexidade:** Baixa
- **Estimativa:** 1 hora
- **Dependências:** Tarefas 78-80
- **Sprint:** Sprint 1

## 🎯 Objetivo
Criar dados de seed para ambiente de testes.
...
Criar dados de seed para ambiente de testes. - Implementar seguindo best practices de infraestrutura e DevOps.
